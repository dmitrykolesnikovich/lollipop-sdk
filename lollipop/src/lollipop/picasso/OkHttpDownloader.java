...
import lollipop.okhttp.Cache;
import lollipop.okhttp.CacheControl;
...
public class OkHttpDownloader implements Downloader {
  ...
  public OkHttpDownloader(final File cacheDir, final long maxSize) {
    ...
    client.setCache(new lollipop.okhttp.Cache(cacheDir, maxSize));
  }
  ...
  public Response load(Uri uri, int networkPolicy) throws IOException {
    ...
    lollipop.okhttp.Response response = client.newCall(builder.build()).execute();
